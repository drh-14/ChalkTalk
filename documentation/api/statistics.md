...
- **`GET /api/v1/courses/{courseId}/statistics/students`**
  - Description: Lists each student's question, answer, and post-view activity during the selected period. An answer contribution counts once per distinct answer the student created or edited, regardless of the number of edits.
  - Authentication: `Cookie: __Host-chalktalk_session=<opaque-session>`.
  - Access: Instructor or TA.
  - Request media: None.
  - Request headers:
