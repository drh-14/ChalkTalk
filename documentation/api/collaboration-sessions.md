...
- **`POST /api/v1/courses/{courseId}/collaboration-sessions`**
  ...
  - Query parameters:
    - None.
  - Request body:
    - Schema: `CreateCollaborationSessionRequest` (required).
...
- **`PATCH /api/v1/collaboration-sessions/{collaborationSessionId}`**
  ...
  - Query parameters:
    - None.
  - Request body:
    - Schema: `EndCollaborationSessionRequest` (required).
...
- **`GET /api/v1/collaboration-sessions/{collaborationSessionId}/snapshot`**
  ...
  - Response body:
    - `data` (object, required): Persisted collaboration text and capture metadata.
      ...
      - `data.persistedAt` (string, required): UTC timestamp of the persisted Yjs state used for the snapshot.
